...
tags:
  - server
  - release
date: "2022-12-19T12:40:32.169Z"
description: New minor release of Tigase XMPP Server packed with improvements has been released.
categories:
  - blog
header:
  overlay_image: /assets/posts/tigase-meet-create-meeting.png
---

Next minor, General Availability version of **Tigase XMPP Server 8.3.0** has been released 

# Tigase XMPP Server 8.3.0

## Major Changes

* Initial version of [Tigase Meet Protocol ](https://xeps.tigase.net/docs/meet-group-videocall/) - our take at SFU (Selective Forwarding Unit) group video-calls
...
* Increased network socket buffer from 2K to 4K to improve performance when reading data from socket. It can increase somewhat memory usage proportionally to number of concurrent user connections. It's possible to configure size of this buffer using `socket-buffer-size` property (please see [`socket-buffer-size` documentation](https://docs.tigase.net/en/tigase-server-8.3.0/Tigase_Administration/Properties/_properties.html#socket-buffer-size)).
...
- [Binaries (distribution packages)](https://github.com/tigase/tigase-server/releases/tag/tigase-server-8.3.0):
  - [tigase-server-8.3.0-b12193-dist-enterprise.tar.gz](https://github.com/tigase/tigase-server/releases/download/tigase-server-8.3.0/tigase-server-8.3.0-b12193-dist-enterprise.tar.gz)
  - [tigase-server-8.3.0-b12193-dist-enterprise.zip](https://github.com/tigase/tigase-server/releases/download/tigase-server-8.3.0/tigase-server-8.3.0-b12193-dist-enterprise.zip)
  - [tigase-server-8.3.0-b12193-dist.tar.gz](https://github.com/tigase/tigase-server/releases/download/tigase-server-8.3.0/tigase-server-8.3.0-b12193-dist.tar.gz)
  - [tigase-server-8.3.0-b12193-dist.zip](https://github.com/tigase/tigase-server/releases/download/tigase-server-8.3.0/tigase-server-8.3.0-b12193-dist.zip)
- [Docker](https://hub.docker.com/r/tigase/tigase-xmpp-server/tags?name=8.3.0)
- [Source Code](https://github.com/tigase/tigase-server/tree/tigase-server-8.3.0)
- [Maven Artifacts](https://maven-repo.tigase.net/#artifact/tigase/tigase-server/8.3.0)
