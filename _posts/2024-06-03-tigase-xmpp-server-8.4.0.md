...
tags:
  - server
  - release
date: "2024-06-03T12:40:32.169Z"
description: New minor release of Tigase XMPP Server packed with improvements has been released.
categories:
  - blog
header:
  overlay_image: /assets/posts/tigase-server-8.4.0-XEP-0227.png
---
...
> **NOTE**: Complete list of changes available in [`tigase-server-8.4.0` milestone](https://tigase.dev/tigase/_server/~milestones/11)
...
- [Binaries (distribution packages)](https://github.com/tigase/tigase-server/releases/tag/tigase-server-8.4.0):
  - [tigase-server-8.4.0-b6793-dist-enterprise.tar.gz](https://github.com/tigase/tigase-server/releases/download/tigase-server-8.4.0/tigase-server-8.4.0-b6793-dist-enterprise.tar.gz)
  - [tigase-server-8.4.0-b6793-dist-enterprise.zip](https://github.com/tigase/tigase-server/releases/download/tigase-server-8.4.0/tigase-server-8.4.0-b6793-dist-enterprise.zip)
  - [tigase-server-8.4.0-b6793-dist.tar.gz](https://github.com/tigase/tigase-server/releases/download/tigase-server-8.4.0/tigase-server-8.4.0-b6793-dist.tar.gz)
  - [tigase-server-8.4.0-b6793-dist.zip](https://github.com/tigase/tigase-server/releases/download/tigase-server-8.4.0/tigase-server-8.4.0-b6793-dist.zip)
- [Docker](https://hub.docker.com/r/tigase/tigase-xmpp-server/tags?name=8.4.0)
- [Source Code](https://tigase.dev/tigase/_server/tigase-server/~files/tigase-server-dist-8.4.0)
- [Maven Artifacts](https://maven-repo.tigase.net/#artifact/tigase/tigase-server/8.4.0)
