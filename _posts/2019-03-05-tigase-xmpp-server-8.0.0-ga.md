...
description: After a long development period and single Release Candidate version Tigase team is proud to present you new major, General Availability release of Tigase XMPP Server packed with many new features and improvements.
categories:
  - blog
header:
